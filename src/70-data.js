...
var BOSSES = {
  ...
  maximvs: { name: 'MC MAXIMVS', spr: 'maximvs', type: 'FLEX', level: 5, ai: 'maximvs', crowd: 0,
    base: { HYPE: 120, FLOW: 20, POISE: 16, TEMPO: 12 }, moves: ['flexstack', 'gladiator', 'themsrules'], xp: 120, money: 80 },
  jake: { name: 'RATTLESNAKE JAKE', spr: 'jake', type: 'ROAST', level: 8, ai: 'jake', crowd: 0,
    base: { HYPE: 160, FLOW: 27, POISE: 18, TEMPO: 16 }, moves: ['venom', 'gravel', 'weakroast'], xp: 180, money: 120 },
